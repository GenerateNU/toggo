...
type CommentRepository interface {
	...
	Delete(ctx context.Context, id uuid.UUID) error
	GetCommentsByEntity(ctx context.Context, tripID uuid.UUID, entityType models.EntityType, entityID uuid.UUID, limit *int, cursor *string) ([]*models.CommentDatabaseResponse, error)
}
