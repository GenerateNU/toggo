...
type MembershipServiceInterface interface {
	...
	GetTripMembers(ctx context.Context, tripID uuid.UUID) ([]*models.Membership, error)
...
func (s *MembershipService) GetTripMembers(ctx context.Context, tripID uuid.UUID) ([]*models.Membership, error) {
	return s.Membership.FindByTripID(ctx, tripID)
}
