...
export const sendBulkNotificationMutationKey = () =>
  [{ url: "/api/v1/notifications/send-bulk" }] as const;

export type SendBulkNotificationMutationKey = ReturnType<
  typeof sendBulkNotificationMutationKey
>;
 ...
 * {@link /api/v1/notifications/send-bulk}
 */
export function useSendBulkNotification<TContext>(
  options: {
  ...
  const mutationKey =
    mutationOptions.mutationKey ?? sendBulkNotificationMutationKey();

  const baseOptions = sendBulkNotificationMutationOptions(
    config,
