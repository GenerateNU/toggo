...
export const sendNotificationMutationKey = () =>
  [{ url: "/api/v1/notifications/send" }] as const;

export type SendNotificationMutationKey = ReturnType<
  typeof sendNotificationMutationKey
>;
 ...
 * {@link /api/v1/notifications/send}
 */
export function useSendNotification<TContext>(
  options: {
  ...
  const mutationKey =
    mutationOptions.mutationKey ?? sendNotificationMutationKey();

  const baseOptions = sendNotificationMutationOptions(
    config,
