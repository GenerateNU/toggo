...
export type TypeaheadPlacesQueryKey = ReturnType<
  typeof typeaheadPlacesQueryKey
>;
 ...
 * {@link /api/v1/search/places/typeahead}
 */
export function useTypeaheadPlaces<
  TData = TypeaheadPlacesQueryResponse,
  TQueryData = TypeaheadPlacesQueryResponse,
  TQueryKey extends QueryKey = TypeaheadPlacesQueryKey,
>(
  params: TypeaheadPlacesQueryParams,
  options: {
    query?: Partial<
