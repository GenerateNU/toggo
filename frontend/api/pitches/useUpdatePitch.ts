...
export async function updatePitch(
  ...
  const res = await request<
    UpdatePitchMutationResponse,
    ResponseErrorConfig<
      UpdatePitch400 | UpdatePitch404 | UpdatePitch422 | UpdatePitch500
    >,
    UpdatePitchMutationRequest
  >({
    method: "PATCH",
 ...
 * {@link /api/v1/trips/:tripID/pitches/:pitchID}
 */
export function useUpdatePitch<TContext>(
  options: {
  ...
  const baseOptions = updatePitchMutationOptions(config) as UseMutationOptions<
    UpdatePitchMutationResponse,
    ResponseErrorConfig<
      UpdatePitch400 | UpdatePitch404 | UpdatePitch422 | UpdatePitch500
    >,
