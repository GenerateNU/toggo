...
export type CheckS3HealthSuspenseQueryKey = ReturnType<
  typeof checkS3HealthSuspenseQueryKey
>;
 ...
 * {@link /api/v1/files/health}
 */
export function useCheckS3HealthSuspense<
  TData = CheckS3HealthQueryResponse,
  TQueryKey extends QueryKey = CheckS3HealthSuspenseQueryKey,
>(
  options: {
    query?: Partial<
      UseSuspenseQueryOptions<
  ...
  const query = useSuspenseQuery(
    ...
    queryClient,
  ) as UseSuspenseQueryResult<TData, ResponseErrorConfig<CheckS3Health503>> & {
    queryKey: TQueryKey;
  };
